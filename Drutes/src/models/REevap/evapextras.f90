...
!! \brief: This module contains the constitutive relations of the evaporation model


module evapextras

  public :: rh_soil, rho_l
  public :: rho_sv,vapor_diff_soil
  public :: tortuosity,vapor_diff_air
  public :: dsurf_tension_soilwat_dT,theta_vapor
  public :: theta_vapor,latent_heat_wat
  public :: enhancement_factor
  public :: drho_sv_dT,hydraulic_vh
  public :: hydraulic_lT, hydraulic_vT,hydraulic_vT
